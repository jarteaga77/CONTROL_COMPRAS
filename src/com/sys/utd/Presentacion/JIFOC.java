...
import com.sys.utd.Daos.Dao_OC;
 ...
 * @author Jonathan
 */
public class JIFOC extends javax.swing.JInternalFrame {

   private ConexionBD conexion;
   private DefaultTableModel modelo;
   private Entidad_OC oc;
   private Entidad_OC_Det det;
   private Dao_OC daoOC;
   ...
   private int idus=MDIPrincipal.getvSeccion();
    ...
    try
    {
       ...
       ResultSet obj2=conexion.executeQuery("SELECT nombre_dirmant FROM utdvvcc.direcmant ORDER BY nombre_dirmant ASC");//Consulta para traer el nombre de centro de costos
            
            while(obj2.next())
            {
                cb_dir.addItem(obj2.getObject("nombre_dirmant"));//Llena JCombobox con el nombre del centro de costos
            }
    ...
    private void initComponents() {
        ...
        cb_dir = new javax.swing.JComboBox();
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Ordenes de Compra --UTDVVCC--");
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cb_proveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 292, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jLabel6))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jLabel16)
                                .addGap(38, 38, 38)
                                .addComponent(txt_cargo_a, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cb_ccostos, 0, 282, Short.MAX_VALUE)
                            .addComponent(cb_dir, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cb_item, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lb_dcto, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jLabel38)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lb_iva, javax.swing.GroupLayout.PREFERRED_SIZE, 195, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel29)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lb_total, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btn_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aceptarActionPerformed
        try
        {
            ...
            int subtotal,total_linea,vlorunitario, idiva;
            float vlordescuento, cantidad, descuento, vloriva;
            int can_par_req = 0;
            ...
            vlorunitario=(Integer.parseInt(txt_vlor_unit.getText()));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        try
        {
            oc=new Entidad_OC();
            daoOC=new Dao_OC();
            int iddir=0, consecutivo=0;
            long proveedor=0, idccostos=0;
            String cotizacion, observaciones,condiciones,cargo;
            ...
            if(cb_dir.getSelectedItem()!=null)
            {
                String nomDir=cb_dir.getSelectedItem().toString();
            ...
            proveedor=Long.parseLong(txt_proveedor.getText());
            cargo=txt_cargo_a.getText();
            cotizacion=txt_cotizacion.getText();
            observaciones=txt_area_obs.getText();
            condiciones=txt_area_con.getText();
            
            
            ResultSet obj3=conexion.executeQuery("SELECT (c.consecutivo +1)AS consecutivo, c.id_centrocostos AS idccostos FROM utdvvcc.centrocostos c JOIN utdvvcc.itemccostos i ON i.id_centrocostos=c.id_centrocostos WHERE i.id_item_ccostos="+iditemccostos+"");
            
            while(obj3.next())
            {
                consecutivo=obj3.getInt("consecutivo");
                idccostos=obj3.getInt("idccostos");
            }
            
            txt_orden.setText(String.valueOf(consecutivo));
            
            oc.setFecha(new Date());
            oc.setId_proveedor(proveedor);
            oc.setIdus(idus);
            oc.setIddirector(iddir);
            oc.setIditemccostos(iditemccostos);
            oc.setCondiciones(condiciones);
            oc.setCotizacion(cotizacion);
            oc.setObservaciones(observaciones);
            oc.setCon_ccostos(consecutivo);
            
            
            conexion.executeUpdateQuery("UPDATE utdvvcc.centrocostos SET consecutivo="+txt_orden.getText()+" WHERE id_centrocostos="+idccostos+"");
            conexion.desconectar();
            
            daoOC.guardar(oc);
            id_oc=Dao_OC.getIdoc();
    ...
    private void btn_catalogoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_catalogoActionPerformed
       try {
           ...
           Logger.getLogger(JIFOC.class.getName()).log(Level.SEVERE, null, ex);
       }
    ...
    private javax.swing.JComboBox cb_dir;
